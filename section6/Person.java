...
public class Person {
  ...
  public String getFullName() {
    String validFirstName = this.firstName.isEmpty() ? "" : this.firstName;
    String validLastName = this.lastName.isEmpty() ? "" : this.lastName;
    String spaceNeeded = this.firstName.isEmpty() || this.lastName.isEmpty() ? "" : " ";
    return validFirstName + spaceNeeded + validLastName;
  }
}
